...
<head>
    ...
    <body>
            ...
            <div id="homeSlider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="{{ asset('/assets/img/slider/slide4.jpg') }}" alt="slide1">
                    ...
                    <div class="item">
                        <img src="{{ asset('/assets/img/slider/slide5.jpg') }}" alt="slide2">
                        <div class="carousel-caption">
							<h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
					...
					<div class="item">
                        <img src="{{ asset('/assets/img/slider/slide6.jpg') }}" alt="slide2">
                        <div class="carousel-caption">
                            <h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
		...
		<div class="row principal-intro-row">
			<div class="container">
				<div class="col-sm-5">
					<img src="{{ asset('/assets/img/principal1.jpg') }}" alt="Our Principal"/>
				</div>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="1">
						<div class="col-md-8 left-event-items">
								<div class="event-item">
									...
									<div class="col-sm-5 event-item-img">
										<div class="event-img">
											<img src="{{ asset('/assets/img/news/news-sm1.jpg') }}" alt="event" />
								...
								<div class="event-item">
									...
									<div class="col-sm-5 event-item-img">
										<div class="event-img">
											<img src="{{ asset('/assets/img/news/news-sm2.jpg') }}" alt="event" />
											<div class="event-detail-link">
												<a href="#">VIEW DETAILS</a>
											</div>
										</div>
						...
						<div class="col-md-4 right-event-items">
							<div class="event-item">
								<img src="{{ asset('/assets/img/news/news-lg3.jpg') }}" alt="event" />
							</div>
					...
					<div class="tab-pane" id="3">
						<div class="col-md-8 left-event-items">
								...
								<div class="event-item">
									...
									<div class="col-sm-5 event-item-img">
										<div class="event-img">
											<img src="{{ asset('/assets/img/news/news-sm3.jpg') }}" alt="event" />
											<div class="event-detail-link">
												<a href="#">VIEW DETAILS</a>
											</div>
										</div>
				...
				<div class="owl-carousel" id="ourTeacher">
					<div class="teacher-item">
						...
						<div class="teacher-item-inner">
							...
							<div class="col-xs-4 clear-padding teacher-img">
								<img src="{{ asset('/assets/img/parent/parent2.jpg') }}" alt="teacher" />
							</div>
					...
					<div class="teacher-item">
						...
						<div class="teacher-item-inner">
							...
							<div class="col-xs-4 clear-padding teacher-img">
								<img src="{{ asset('/assets/img/parent/parent1.jpg') }}" alt="teacher" />
							</div>
							<div class="col-xs-8 teacher-details">
			...
			<div class="container">
				...
				<div class="col-sm-6 col-md-4">
					<div class="news-item-container">
						<div class="news-img">
							<img src="{{ asset('/assets/img/news/news-sm1.jpg') }}" alt="news"/>
				...
				<div class="col-sm-6 col-md-4">
					<div class="news-item-container">
						<div class="news-img">
							<img src="{{ asset('/assets/img/news/news-sm2.jpg') }}" alt="news"/>
							<div class="news-item-date">
				...
				<div class="col-sm-6 col-md-4">
					<div class="news-item-container">
						<div class="news-img">
							<img src="{{ asset('/assets/img/news/news-sm3.jpg') }}" alt="news"/>
							<div class="news-item-date">
			...
			<div class="container">
				...
				<div class="owl-carousel" id="parentTestimonial">
					<div class="parent-test-item">
						<div class="col-sm-3">
							<div class="parent-img">
								<img src="{{ asset('/assets/img/parent/parent1.jpg') }}" alt="parent"/>
							</div>
						</div>
						<div class="col-sm-9">
					...
					<div class="parent-test-item">
						<div class="col-sm-3">
							<div class="parent-img">
								<img src="{{ asset('/assets/img/parent/parent2.jpg') }}" alt="parent"/>
							</div>
						</div>
						<div class="col-sm-9">
        ...
        <!-- Scripts -->
        <script src="{{ asset('/assets/js/jQuery_v3_2_0.min.js') }}"></script>
